...
function PdfRellenado() {
  ...
  const [positions] = useState([
    ...
    },
    {
      x: 70,
      y: 580,
      text: "Control de Glaciares, periglaciares y lugares cercanos a la montañas, para proteger los glaciares y evitar su desaparición.",
    },
  ]);
  ...
  return (
    <div className="App">
      ...
      <h1 style={{ color: "#3f51b5" }}>Honorables - PD</h1>
      ...
      <div class="pdf-container">
        <iframe src="{samplePDF}" class="pdf-file"></iframe>
      </div>
